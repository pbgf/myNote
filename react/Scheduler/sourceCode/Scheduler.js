...
var taskQueue = []; // 存放当前需要执行的任务
var timerQueue = []; // 存放稍后执行的任务
...
var isHostCallbackScheduled = false; // 是否正在执行回调函数中，因为中间存在 onmessage 所以需要一个flag占用
var isHostTimeoutScheduled = false;

// 把当前计时器队列的任务梳理下，看有没有可以推到 任务队列中的
